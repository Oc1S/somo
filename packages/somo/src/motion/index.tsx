...
import { Component, ParentProps, Ref, useContext } from 'solid-js';
...
export interface MotionComponentConfig<Instance, RenderState> {
  ...
  Component: string | Component<ParentProps<{}>>;
}
 ...
 */
export function createRendererMotionComponent<Props extends {}, Instance, RenderState>({
  preloadedFeatures,
  createVisualElement,
  useRender,
  useVisualState,
  ...
  function MotionComponent(props: MotionComponentProps<Props>, externalRef?: Ref<Instance>) {
    /**
     * If we need to measure the element we load this functionality in a
     * separate class component in order to gain access to getSnapshotBeforeUpdate.
     */
    let MeasureLayout: Component<MotionProps> | undefined;
