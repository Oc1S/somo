import { MotionConfigContext, ReducedMotionConfig } from '../context/MotionConfigContext';
...
import { ResolvedValues, VisualElementEventCallbacks, VisualElementOptions } from './types';
